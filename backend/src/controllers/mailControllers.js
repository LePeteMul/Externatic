...
const sendCompanyPasswordResetMail = (req, res) => {
  const { email, ipLocal, date } = req.body;
  ...
  const resetPasswordLink = `http://localhost:3000/company/edition/resetpassword?email=${encodeURIComponent(
    email
  )}`;
